...
top10url = dict((url,score) for url,score in top10)

#generate final list of 10 articles
timeline_articles = []
for top_article_url in top10url:
        for article in responseRel["articles"]:
                if article["url"] == top_article_url:
                        timeline_articles.append(article)

#print to test
print(timeline_articles)